...
(function() {
  ...
  this.app.Chart = (function() {
    ...
    Chart.prototype.drawChart = function(value) {
      var areaForEachTile, cols, i, margin, numberOfTiles, shape, tileHeight, tileWidth, x, y, _i;
      ...
      for (i = _i = 0; 0 <= numberOfTiles ? _i < numberOfTiles : _i > numberOfTiles; i = 0 <= numberOfTiles ? ++_i : --_i) {
